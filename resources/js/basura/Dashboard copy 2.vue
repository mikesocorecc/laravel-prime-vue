        ...
        <nav class="bg-white border-b border-gray-200 fixed z-30 w-full">
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start"> <!-- Busqueda -->
                        ...
                        <form action="#"   class="hidden lg:block lg:pl-32">
                            ...
                            <div class="mt-1 relative lg:w-64">
                                ...
                                <input type="text" name="email" id="topbar-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 focus-visible:outline-none block w-full pl-10 p-2.5 " autocomplete="off" placeholder="Búsqueda">
                            </div>
                        </form>
                    </div> 
                    <div class="flex items-center"><!-- iconos menu nav -->
                        ...
                        <div class="hidden lg:flex items-center">
                            <span class="text-base font-normal text-gray-500 mr-5">Fuente abierta ❤️</span>
                            <div class="-mb-1">
                                <a href="" class="bg-gray-200 rounded px-2 py-1 border-2">Github</a>
                            </div>
                        </div>
                ...
                <div class="relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0">
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            ...
                            <div class="space-y-2 pt-2"><!--Botones redirecion -->
